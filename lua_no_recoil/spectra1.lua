...
function OnEvent(event, arg)
    ...
    --toggle script--
    if (event== "MOUSE_BUTTON_PRESSED" and arg == toggleNoRecoil_gKey) then
...
Perfect settings according to screen resolution, fov and sensitivity

activar el script solo mientras se mantenga pulsado el botón derecho del ratóm

correos:
    coffee.spectra@gmail.com
